...
const puzzle = (text) => {
	...
	// const veeGrid = makeVeeGrid(grid);
	// console.log(me.fuseGrid(veeGrid));
	...
	const flatBegin = makeCoordsFlat(startCoord);
	return stepScores[flatBegin];
};
